d3.csv("./data/beerStyleCountIbu2.csv").then(function(data) {

    /*
    DEFINE DIMENSIONS OF SVG + CREATE SVG CANVAS
    */
    const width = document.querySelector("#chartibu").clientWidth;
    const height = document.querySelector("#chartibu").clientHeight;
    const margin = {top: 20, left: 120, right: 50, bottom: 120};

    const svg = d3.select("#chartibu")
        .append("svg")
        .attr("width", width)
        .attr("height", height);
    ...
    */   
    const line = d3.line()
        .x(function(d) { return xScale(d.avgibu); })
    ...
    */
    ...
    let circle = svg.selectAll("circle")
        ...
        .enter()
        .append("circle")
            .attr("cx", function(d) { return xScale(d.avgibu); })
    ...
    TOOLTIP
    */
    const tooltip = d3.select("#chartibu")
        .append("div")
        .attr("class", "tooltip");
    ...
    function mouseOverFunction(e, d) {
        ...
        tooltip.style("visibility","visible") 
            .style("left", `${cx}px`)
            .style("top", `${cy}px`)
            .html(`Average IBU: ${d.avgibu}<br>Number of Products: ${d.count}`);
        d3.select(this)
            .attr("stroke","white")
            .attr("stroke-width",4);
    };
    ...
    */
    ...
    // UPDATE LINE 
    d3.select("#APA").on("click", function() {
    path.datum(data_APA)
        .transition()
        .duration(1500)
        .attr("d", line)
    ...
    let c = svg.selectAll("circle")
        .data(data_APA, function(d) { return d.avgibu; });
    ...
    */
    ...
    // UPDATE LINE 
    d3.select("#IPA").on("click", function() {
        path.datum(data_IPA)
            .transition()
            .duration(1500)
            .attr("d", line)
    ...
    // UPDATE CIRCLES 
    let c = svg.selectAll("circle")
        .data(data_IPA, function(d) { return d.avgibu; });
    c.enter().append("circle")
            .attr("cx", function(d) { return xScale(d.avgibu); })
            .attr("cy", function(d) { return yScale(d.count); })
            .attr("r",6)
    ...
    */
    ...
    // UPDATE CIRCLES 
    let c = svg.selectAll("circle")
        .data(data_IMP, function(d) { return d.avgibu; });
    c.enter().append("circle")
            .attr("cx", function(d) { return xScale(d.avgibu); })
            .attr("cy", function(d) { return yScale(d.count); })
            .attr("r",6)
    ...
    */
    ...
    // UPDATE LINE 
    d3.select("#Blonde").on("click", function() {
    ...
    // UPDATE CIRCLES 
    let c = svg.selectAll("circle")
        .data(data_Blonde, function(d) { return d.avgibu; });
    c.enter().append("circle")
            .attr("cx", function(d) { return xScale(d.avgibu); })
            .attr("cy", function(d) { return yScale(d.count); })
            .attr("r",6)
    ...
    */
    ...
    // UPDATE LINE 
    d3.select("#Amber").on("click", function() {
    ...
    // UPDATE CIRCLES 
    let c = svg.selectAll("circle")
        .data(data_Amber, function(d) { return d.avgibu; });
    c.enter().append("circle")
            .attr("fill","#FF528B")
            .attr("cx", function(d) { return xScale(d.avgibu); })
            .attr("cy", function(d) { return yScale(d.count); })
